...
export function ProjectFeaturesTab({ projectId, showToast }: Props) {
    ...
    <div className="max-w-2xl space-y-5">
      ...
      <div className="space-y-2">
        {loading ? (
          ...
          <div className="py-10 text-center text-sm text-[#9ca3af]">No features yet. Add key highlights above.</div>
        ) : (
          features.map((f) => (
